...
func (g *Backendv3) Records(name string, exact bool, rmtIP net.IP) ([]msg.Service, error) {
...
func (g *Backendv3) ReverseRecord(name string, rmtIP net.IP) (*msg.Service, error) {
	path, star := msg.PathWithWildcard(name)
	if star {
